...
while reloj < 10000000:
    #Generamos el tiempo que va a llegar el cliente
    intervalo = generar_interarribos()
    #Sumamos ese tiempo al reloj para saber si puede entrar y que no le va a cerrar la lavanderia
    reloj += intervalo

    if reloj > 10000000: break   #Si llega despues que la maquina termina, no se hace nada
...
if cantidad_clientes > 0:
    ...
    utilizacion_maquina_lavadora = tiempo_ocupado_maquina / 10000000
